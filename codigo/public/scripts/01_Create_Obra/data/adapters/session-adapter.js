...
function clearRenderedObras() {
  ...
  obras.forEach((obra, index) => {
    ...
    // Verificar se a obra JÁ FOI SALVA
    ...
    if (hasSaveButton && !hasProjects && !isObraInSession(obraId)) {
      console.log(` REMOVENDO: ${obraName} - Obra não salva e vazia`);
      obra.remove();
      obrasRemovidas++;
    } else {
  ...
  console.log(
    ` clearRenderedObras finalizado: ${obrasPreservadas} preservadas, ${obrasRemovidas} removidas`,
  );
}
